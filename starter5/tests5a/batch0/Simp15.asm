  .byte 32 # StringLit at 6.15
  .byte 46 # StringLit at 6.15
  .byte 46 # StringLit at 6.15
  .byte 46 # StringLit at 6.15
  .byte 32 # StringLit at 6.15
  .byte 10 # StringLit at 6.15
  .byte 0 # StringLit at 6.15
  .byte 0 # StringLit at 6.15
  .word CLASS_String # StringLit at 6.15
  .word 3 # StringLit at 6.15
  .word -6 # StringLit at 6.15
strLit_17: # StringLit at 6.15
.text
.globl main
main:
  jal vm_init
...
mth_main_Main: # MethodDeclVoid at 2.15; stackHeight = 0
 ...
 li $t0, 321 # IntLit at 3.21; stackHeight = 0
 subu $sp, $sp , 4 # IntLit at 3.21; stackHeight = 0
 sw t$0, 0($sp) # IntLit at 3.21; stackHeight = 0
 lw $t0, -4($fp # IDExp at 4.21; stackHeight = 4
 subu $sp, $sp , 4 # IDExp at 4.21; stackHeight = 4
 sw $t0, 0($sp) # IDExp at 4.21; stackHeight = 4
 li $t0, 18 # IntLit at 4.25; stackHeight = 8
 subu $sp, $sp , 4 # IntLit at 4.25; stackHeight = 8
 sw t$0, 0($sp) # IntLit at 4.25; stackHeight = 8
 lw $t1, 0($sp) # Plus at 4.24; stackHeight = 12
 addu $sp, $sp , 4 # Plus at 4.24; stackHeight = 12
 lw $t0, 0($sp) # Plus at 4.24; stackHeight = 8
 addu $sp, $sp , 4 # Plus at 4.24; stackHeight = 8
 addu $t0, $t0, $t1 # Plus at 4.24; stackHeight = 4
 subu $sp, $sp , 4 # Plus at 4.24; stackHeight = 4
 sw $t0, 0($sp) # Plus at 4.24; stackHeight = 4
 li $t0, 23 # IntLit at 5.14; stackHeight = 8
 subu $sp, $sp , 4 # IntLit at 5.14; stackHeight = 8
 sw t$0, 0($sp) # IntLit at 5.14; stackHeight = 8
 lw $t0, -4($fp # IDExp at 5.17; stackHeight = 12
 subu $sp, $sp , 4 # IDExp at 5.17; stackHeight = 12
 sw $t0, 0($sp) # IDExp at 5.17; stackHeight = 12
 lw $t1, 0($sp) # Minus at 5.16; stackHeight = 16
 addu $sp, $sp , 4 # Minus at 5.16; stackHeight = 16
 lw $t0, 0($sp) # Minus at 5.16; stackHeight = 12
 addu $sp, $sp , 4 # Minus at 5.16; stackHeight = 12
 subu $t0, $t0, $t1 # Minus at 5.16; stackHeight = 8
 subu $sp, $sp , 4 # Minus at 5.16; stackHeight = 8
 sw $t0, 0($sp) # Minus at 5.16; stackHeight = 8
 la $t0, strLit_136 # StringLit at 6.15; stackHeight = 12
 subu $sp, $sp , 4 # StringLit at 6.15; stackHeight = 12
 sw t$0, 0($sp) # StringLit at 6.15; stackHeight = 12
 subu $sp, $sp , 4 # Call at 7.11; stackHeight = 16
 sw $s2, 0($sp) # Call at 7.11; stackHeight = 16
 li $t0, 29 # IntLit at 7.20; stackHeight = 20
 subu $sp, $sp , 4 # IntLit at 7.20; stackHeight = 20
 sw t$0, 0($sp) # IntLit at 7.20; stackHeight = 20
 lw $t0, -12($fp # IDExp at 7.23; stackHeight = 24
 subu $sp, $sp , 4 # IDExp at 7.23; stackHeight = 24
 sw $t0, 0($sp) # IDExp at 7.23; stackHeight = 24
 lw $t1, 0($sp) # Plus at 7.22; stackHeight = 28
 addu $sp, $sp , 4 # Plus at 7.22; stackHeight = 28
 lw $t0, 0($sp) # Plus at 7.22; stackHeight = 24
 addu $sp, $sp , 4 # Plus at 7.22; stackHeight = 24
 addu $t0, $t0, $t1 # Plus at 7.22; stackHeight = 20
 subu $sp, $sp , 4 # Plus at 7.22; stackHeight = 20
 sw $t0, 0($sp) # Plus at 7.22; stackHeight = 20
 subu $sp, $sp , 4 # This at 7.11; stackHeight = 24
 sw $s2, 0($sp) # This at 7.11; stackHeight = 24
 lw $s2, 0($sp) # Call at 7.11; stackHeight = 28
 addu $sp, $sp , 4 # Call at 7.11; stackHeight = 28
 lw $t0, -12($s2) # Call at 7.11; stackHeight = 24
  lw   $t0, 32($t0) # Call at 7.11; stackHeight = 24
  jalr $t0 # Call at 7.11; stackHeight = 24
  addu $sp, $sp, 8 # Call at 7.11; stackHeight = 24
 lw $s2, 0($sp) # Call at 7.11; stackHeight = 16
 addu $sp, $sp , 4 # Call at 7.11; stackHeight = 16
 subu $sp, $sp , 4 # Call at 8.11; stackHeight = 12
 sw $s2, 0($sp) # Call at 8.11; stackHeight = 12
 lw $t0, -16($fp # IDExp at 8.20; stackHeight = 16
 subu $sp, $sp , 4 # IDExp at 8.20; stackHeight = 16
 sw $t0, 0($sp) # IDExp at 8.20; stackHeight = 16
 subu $sp, $sp , 4 # This at 8.11; stackHeight = 20
 sw $s2, 0($sp) # This at 8.11; stackHeight = 20
 lw $s2, 0($sp) # Call at 8.11; stackHeight = 24
 addu $sp, $sp , 4 # Call at 8.11; stackHeight = 24
 lw $t0, -12($s2) # Call at 8.11; stackHeight = 20
  lw   $t0, 24($t0) # Call at 8.11; stackHeight = 20
  jalr $t0 # Call at 8.11; stackHeight = 20
  addu $sp, $sp, 4 # Call at 8.11; stackHeight = 20
 lw $s2, 0($sp) # Call at 8.11; stackHeight = 16
 addu $sp, $sp , 4 # Call at 8.11; stackHeight = 16
  move $sp, $fp # MethodDeclVoid at 2.15; stackHeight = 12
  lw   $ra, 0($sp) # MethodDeclVoid at 2.15; stackHeight = 12
  addu $sp, $sp, 4 # MethodDeclVoid at 2.15; stackHeight = 12
  jr   $ra # MethodDeclVoid at 2.15; stackHeight = 12
##############################################################
