...
mth_main_Main: # MethodDeclVoid at 2.15; stackHeight = 0
 ...
 subu $sp, $sp , 4 # Call at 3.5; stackHeight = 0
 sw $s2, 0($sp) # Call at 3.5; stackHeight = 0
 li $t0, 345 # IntLit at 3.14; stackHeight = 4
 subu $sp, $sp , 4 # IntLit at 3.14; stackHeight = 4
 sw t$0, 0($sp) # IntLit at 3.14; stackHeight = 4
 subu $sp, $sp , 4 # This at 3.5; stackHeight = 8
 sw $s2, 0($sp) # This at 3.5; stackHeight = 8
 lw $s2, 0($sp) # Call at 3.5; stackHeight = 12
 addu $sp, $sp , 4 # Call at 3.5; stackHeight = 12
 lw $t0, -12($s2) # Call at 3.5; stackHeight = 8
  lw   $t0, 32($t0) # Call at 3.5; stackHeight = 8
  jalr $t0 # Call at 3.5; stackHeight = 8
  addu $sp, $sp, 8 # Call at 3.5; stackHeight = 8
 lw $s2, 0($sp) # Call at 3.5; stackHeight = 0
 addu $sp, $sp , 4 # Call at 3.5; stackHeight = 0
