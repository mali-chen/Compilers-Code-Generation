...
mth_main_Main: # MethodDeclVoid at 2.15; stackHeight = 0
 ...
 subu $sp, $sp , 4 # Call at 4.13; stackHeight = 4
 sw $s2, 0($sp) # Call at 4.13; stackHeight = 4
 lw $t0, -4($fp # IDExp at 4.22; stackHeight = 8
 subu $sp, $sp , 4 # IDExp at 4.22; stackHeight = 8
 sw $t0, 0($sp) # IDExp at 4.22; stackHeight = 8
 li $t0, 263 # IntLit at 4.26; stackHeight = 12
 subu $sp, $sp , 4 # IntLit at 4.26; stackHeight = 12
 sw t$0, 0($sp) # IntLit at 4.26; stackHeight = 12
 lw $t1, 0($sp) # Minus at 4.25; stackHeight = 16
 addu $sp, $sp , 4 # Minus at 4.25; stackHeight = 16
 lw $t0, 0($sp) # Minus at 4.25; stackHeight = 12
 addu $sp, $sp , 4 # Minus at 4.25; stackHeight = 12
 subu $t0, $t0, $t1 # Minus at 4.25; stackHeight = 8
 subu $sp, $sp , 4 # Minus at 4.25; stackHeight = 8
 sw $t0, 0($sp) # Minus at 4.25; stackHeight = 8
 subu $sp, $sp , 4 # Super at 4.13; stackHeight = 12
 sw $s2, 0($sp) # Super at 4.13; stackHeight = 12
 lw $s2, 0($sp) # Call at 4.13; stackHeight = 16
 addu $sp, $sp , 4 # Call at 4.13; stackHeight = 16
  jal  mth_printInt_Lib # Call at 4.13; stackHeight = 12
  addu $sp, $sp, 8 # Call at 4.13; stackHeight = 12
 lw $s2, 0($sp) # Call at 4.13; stackHeight = 4
 addu $sp, $sp , 4 # Call at 4.13; stackHeight = 4
