  .byte 10 # StringLit at 6.26
  .byte 0 # StringLit at 6.26
  .byte 0 # StringLit at 6.26
  .byte 0 # StringLit at 6.26
  .word CLASS_String # StringLit at 6.26
  .word 2 # StringLit at 6.26
  .word -1 # StringLit at 6.26
strLit_16: # StringLit at 6.26
.text
.globl main
main:
  jal vm_init
...
mth_main_Main: # MethodDeclVoid at 2.15; stackHeight = 0
 ...
 subu $sp, $sp , 4 # Call at 5.17; stackHeight = 8
 sw $s2, 0($sp) # Call at 5.17; stackHeight = 8
 lw $t0, -8($fp # IDExp at 5.26; stackHeight = 12
 subu $sp, $sp , 4 # IDExp at 5.26; stackHeight = 12
 sw $t0, 0($sp) # IDExp at 5.26; stackHeight = 12
 li $t0, 17 # IntLit at 5.30; stackHeight = 16
 subu $sp, $sp , 4 # IntLit at 5.30; stackHeight = 16
 sw t$0, 0($sp) # IntLit at 5.30; stackHeight = 16
 lw $t1, 0($sp) # Plus at 5.29; stackHeight = 20
 addu $sp, $sp , 4 # Plus at 5.29; stackHeight = 20
 lw $t0, 0($sp) # Plus at 5.29; stackHeight = 16
 addu $sp, $sp , 4 # Plus at 5.29; stackHeight = 16
 addu $t0, $t0, $t1 # Plus at 5.29; stackHeight = 12
 subu $sp, $sp , 4 # Plus at 5.29; stackHeight = 12
 sw $t0, 0($sp) # Plus at 5.29; stackHeight = 12
 subu $sp, $sp , 4 # Super at 5.17; stackHeight = 16
 sw $s2, 0($sp) # Super at 5.17; stackHeight = 16
 lw $s2, 0($sp) # Call at 5.17; stackHeight = 20
 addu $sp, $sp , 4 # Call at 5.17; stackHeight = 20
  jal  mth_printInt_Lib # Call at 5.17; stackHeight = 16
  addu $sp, $sp, 8 # Call at 5.17; stackHeight = 16
 lw $s2, 0($sp) # Call at 5.17; stackHeight = 8
 addu $sp, $sp , 4 # Call at 5.17; stackHeight = 8
 subu $sp, $sp , 4 # Call at 6.17; stackHeight = 4
 sw $s2, 0($sp) # Call at 6.17; stackHeight = 4
 la $t0, strLit_160 # StringLit at 6.26; stackHeight = 8
 subu $sp, $sp , 4 # StringLit at 6.26; stackHeight = 8
 sw t$0, 0($sp) # StringLit at 6.26; stackHeight = 8
 subu $sp, $sp , 4 # Super at 6.17; stackHeight = 12
 sw $s2, 0($sp) # Super at 6.17; stackHeight = 12
 lw $s2, 0($sp) # Call at 6.17; stackHeight = 16
 addu $sp, $sp , 4 # Call at 6.17; stackHeight = 16
  jal  mth_printStr_Lib # Call at 6.17; stackHeight = 12
  addu $sp, $sp, 4 # Call at 6.17; stackHeight = 12
 lw $s2, 0($sp) # Call at 6.17; stackHeight = 8
 addu $sp, $sp , 4 # Call at 6.17; stackHeight = 8
