...
mth_main_Main: # MethodDeclVoid at 2.15; stackHeight = 0
 ...
 lw $t1, 0($sp) # Plus at 4.19; stackHeight = 16
 addu $sp, $sp , 4 # Plus at 4.19; stackHeight = 16
 lw $t0, 0($sp) # Plus at 4.19; stackHeight = 12
 addu $sp, $sp , 4 # Plus at 4.19; stackHeight = 12
 addu $t0, $t0, $t1 # Plus at 4.19; stackHeight = 8
 subu $sp, $sp , 4 # Plus at 4.19; stackHeight = 8
 sw $t0, 0($sp) # Plus at 4.19; stackHeight = 8
