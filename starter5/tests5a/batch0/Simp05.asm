  .byte 72 # StringLit at 3.16
  .byte 101 # StringLit at 3.16
  .byte 108 # StringLit at 3.16
  .byte 108 # StringLit at 3.16
  .byte 111 # StringLit at 3.16
  .byte 46 # StringLit at 3.16
  .byte 10 # StringLit at 3.16
  .byte 0 # StringLit at 3.16
  .word CLASS_String # StringLit at 3.16
  .word 3 # StringLit at 3.16
  .word -7 # StringLit at 3.16
strLit_0: # StringLit at 3.16
.text
.globl main
main:
  jal vm_init
...
mth_main_Main: # MethodDeclVoid at 2.15; stackHeight = 0
 ...
 subu $sp, $sp , 4 # Call at 3.7; stackHeight = 0
 sw $s2, 0($sp) # Call at 3.7; stackHeight = 0
 la $t0, strLit_63 # StringLit at 3.16; stackHeight = 4
 subu $sp, $sp , 4 # StringLit at 3.16; stackHeight = 4
 sw t$0, 0($sp) # StringLit at 3.16; stackHeight = 4
 subu $sp, $sp , 4 # This at 3.7; stackHeight = 8
 sw $s2, 0($sp) # This at 3.7; stackHeight = 8
 lw $s2, 0($sp) # Call at 3.7; stackHeight = 12
 addu $sp, $sp , 4 # Call at 3.7; stackHeight = 12
 lw $t0, -12($s2) # Call at 3.7; stackHeight = 8
  lw   $t0, 24($t0) # Call at 3.7; stackHeight = 8
  jalr $t0 # Call at 3.7; stackHeight = 8
  addu $sp, $sp, 4 # Call at 3.7; stackHeight = 8
 lw $s2, 0($sp) # Call at 3.7; stackHeight = 4
 addu $sp, $sp , 4 # Call at 3.7; stackHeight = 4
