...
mth_main_Main: # MethodDeclVoid at 2.15; stackHeight = 0
 ...
 subu $sp, $sp , 4 # Call at 7.17; stackHeight = 16
 sw $s2, 0($sp) # Call at 7.17; stackHeight = 16
 li $t0, 29 # IntLit at 7.26; stackHeight = 20
 subu $sp, $sp , 4 # IntLit at 7.26; stackHeight = 20
 sw t$0, 0($sp) # IntLit at 7.26; stackHeight = 20
 lw $t0, -12($fp # IDExp at 7.29; stackHeight = 24
 subu $sp, $sp , 4 # IDExp at 7.29; stackHeight = 24
 sw $t0, 0($sp) # IDExp at 7.29; stackHeight = 24
 lw $t1, 0($sp) # Plus at 7.28; stackHeight = 28
 addu $sp, $sp , 4 # Plus at 7.28; stackHeight = 28
 lw $t0, 0($sp) # Plus at 7.28; stackHeight = 24
 addu $sp, $sp , 4 # Plus at 7.28; stackHeight = 24
 addu $t0, $t0, $t1 # Plus at 7.28; stackHeight = 20
 subu $sp, $sp , 4 # Plus at 7.28; stackHeight = 20
 sw $t0, 0($sp) # Plus at 7.28; stackHeight = 20
 subu $sp, $sp , 4 # Super at 7.17; stackHeight = 24
 sw $s2, 0($sp) # Super at 7.17; stackHeight = 24
 lw $s2, 0($sp) # Call at 7.17; stackHeight = 28
 addu $sp, $sp , 4 # Call at 7.17; stackHeight = 28
  jal  mth_printInt_Lib # Call at 7.17; stackHeight = 24
  addu $sp, $sp, 8 # Call at 7.17; stackHeight = 24
 lw $s2, 0($sp) # Call at 7.17; stackHeight = 16
 addu $sp, $sp , 4 # Call at 7.17; stackHeight = 16
 subu $sp, $sp , 4 # Call at 8.17; stackHeight = 12
 sw $s2, 0($sp) # Call at 8.17; stackHeight = 12
 lw $t0, -16($fp # IDExp at 8.26; stackHeight = 16
 subu $sp, $sp , 4 # IDExp at 8.26; stackHeight = 16
 sw $t0, 0($sp) # IDExp at 8.26; stackHeight = 16
 subu $sp, $sp , 4 # Super at 8.17; stackHeight = 20
 sw $s2, 0($sp) # Super at 8.17; stackHeight = 20
 lw $s2, 0($sp) # Call at 8.17; stackHeight = 24
 addu $sp, $sp , 4 # Call at 8.17; stackHeight = 24
  jal  mth_printStr_Lib # Call at 8.17; stackHeight = 20
  addu $sp, $sp, 4 # Call at 8.17; stackHeight = 20
 lw $s2, 0($sp) # Call at 8.17; stackHeight = 16
 addu $sp, $sp , 4 # Call at 8.17; stackHeight = 16
